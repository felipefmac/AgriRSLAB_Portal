...
|---------|-----------|-----------|------------|--------|
| ES-001 | *Scrum Master:* Facilitar cerimônias ágeis (Daily, Planning, Review, Retrospective), acompanhar impedimentos, garantir comunicação eficaz e apoiar a equipe na aplicação do DoD. | 20 | ES | 1,2,3 |
